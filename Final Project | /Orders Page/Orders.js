...
function calculateIdValue() {
    //Here we are getting the values of the id's and if it is not a number then it will be 0
...
function copyBillingAddress() {
    if ($("#sameCopy").is(":checked") && $("#sameCopy").val() === "yes") {
        //Here we are copying the values from the shipping address to the billing address and if it is not checked then it will be empty
